...
import updateSechemVisualChanges from "../sechem/utils/handle-visual-changes.js";
...
function changeSechemSelectOptions(optionsArray) {
    ...
    // Dispatch the change event to trigger the event listener
    let event = new Event(changeEvent, { bubbles: true });
