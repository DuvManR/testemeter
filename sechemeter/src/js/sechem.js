...
import getUniSechemTreshold from "./sechem/utils/handle-google-sheet.js";
import {
	calculateTauFirst,
	calculateTauFinal,
} from "./sechem/by-university/tau-sechem.js";
import {
	calculateHujiFirst,
	calculateHujiFinal,
} from "./sechem/by-university/huji-sechem.js";
import {
	calculateTechFirst,
	calculateTechFinal,
} from "./sechem/by-university/tech-sechem.js";
import { calculateBguFirst } from "./sechem/by-university/bgu-sechem.js";
import {
	calculateBiuFirst,
	calculateBiuFinal,
} from "./sechem/by-university/biu-sechem.js";
...
document.getElementById("calc-button").addEventListener("click", function () {
	...
	switch (selectedOption) {
		...
		case "BIU-FINAL":
			...
			break;
		default:
			displayResults("sechem-results", "יש לבחור מוסד לימודים ❗");
	}
...
document.getElementById("sechem-universities").onchange = function () {
	...
	// Clears results
	displayResults("sechem-results", "סכם: 0");
};
...
async function createSechemTable(selectedOption, newSechemTableBody) {
	...
	[selectedUniversity, sechemType] = selectedOption.split("-");

	let sechemTresholds = await getUniSechemTreshold("Tresholds");
